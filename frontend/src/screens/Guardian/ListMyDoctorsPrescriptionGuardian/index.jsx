...
export default function ListMyDoctorsPrescriptionGuardian({route}) {
            ...
            <View style={styles.content}>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => <MemoizedDoctors
                        data={item}
                        onPress={() => navigation.navigate('ShowPrescriptionPatientGuardian', { doctor: item, patient: patient })}
                    />}
