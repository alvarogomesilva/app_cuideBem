...
export default function ListMyDoctorsPrescriptionCaregiver({route}) {
            ...
            <View style={styles.content}>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => <MemoizedDoctors
                        data={item}
                        onPress={() => navigation.navigate('ShowPrescriptionPatientCaregiver', { doctor: item, patient: patient })}
                    />}
